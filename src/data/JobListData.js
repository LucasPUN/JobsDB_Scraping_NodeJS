const jobListData = [{
    ...
    "detailData": {"jobAdDetails": "Job Responsibilities:\n\nResponsible for application systems development at enterprise level\nPerforming analyses on business requirement translate into technical task and functional specification\nTrack project requirement from their origin to the deliverables that satisfy customer need\nProvide technical suggestion to developer, resolve issue between requirement and technical task\nCollaborating with Business Analyst, UX/UI, QA and other IT teams to Identify opportunity that needs to be addressed and provide solution to customer\n\nJob Requirements\n\nDegree holder in Computer Science or equivalent\nAt least 4 years of hands-on development experience \nExperience in web-based application(s) and RESTful Web APIs using Microsoft .NET Core/Framework and Microsoft SQL Server\nExperience in NoSQL databases including MongoDB;\nIT experience in designing and implementing back-end application(s) using Node.js;\nIT experience in designing and implementing Progressive Web Applications (PWAs) using React;\nGood technical documentation and communication skills\nAbility to quickly adapt and learn new technologies and systems"}
}]
